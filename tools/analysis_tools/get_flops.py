...
def parse_args():
    ...
    parser.add_argument('--config', default=r'C:\Users\70436\mmsegmentation\configs\stdc\stdc2_in1k-pre_4xb12-80k_cityscapes-512x1024.py', help='train config file path')
    parser.add_argument(
        '--shape',
        type=int,
        nargs='+',
